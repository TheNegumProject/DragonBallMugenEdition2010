...
;---------------------------------------------------------------------------
;Turtle Destruction Blast/Kame Hame Ha
[State -1, KameHameHa]
type = ChangeState
value = 1800
...
trigger1 = statetype = S && ctrl
;---------------------------------------------------------------------------
;Aerial Turtle Destruction Blast/Aerial Kame Hame Ha
[State -1, KameHameHa]
type = ChangeState
value = 1850
triggerall = (command = "KameHameHa1" || command = "KameHameHa2" || command = "KameHameHa3") && command != "holddown" && power >= 1000
...
type = ChangeState
value = 2200
triggerall = command = "Sokidan" && command != "holddown" && power >= 2000 && NumHelper(2250) = 0
trigger1 = statetype = S && ctrl
trigger2 = stateno = 3100
;---------------------------------------------------------------------------
;Spirit Bomb/Souki Dan
...
type = ChangeState
value = 2201
triggerall = command = "Sokidan" && command != "holddown" && NumHelper(2250) = 1
trigger1 = statetype = S && ctrl
trigger2 = stateno = 3100
;===========================================================================
...
type = ChangeState
value = 2900
triggerall = (command = "c"  && command = "z") && (prevstateno != 2900 || prevstateno != 2901) && (stateno = 100 || stateno = 102)
...
type = ChangeState
value = 2905
triggerall = (command = "c"  && command = "z") && (prevstateno != 2905 || prevstateno != 2906) && (stateno = 105)
trigger1 = (statetype = S || statetype = A) && ctrl = 1 
;---------------------------------------------------------------------------
...
type = ChangeState
value = 2907
triggerall = (command = "c"  && command = "z") && (prevstateno != 2905 || prevstateno != 2906) && (stateno = 107)
trigger1 = (statetype = S || statetype = A) && ctrl = 1 
;---------------------------------------------------------------------------
;Advancing Guard
;[State -1, AdvancingGuard]
...
trigger9 = (stateno = 1100 || stateno = 1110 || stateno = 1120) && movecontact
;---------------------------------------------------------------------------
; Medium Fireball
[State -1, M.Fireball]
type = ChangeState
...
trigger7 = stateno = 240 && movecontact
trigger8 = stateno = 250 && movecontact
trigger9 = (stateno = 1000 || stateno = 1010 || stateno = 1020) && movecontact
trigger10 = (stateno = 1100 || stateno = 1110 || stateno = 1120) && movecontact
;---------------------------------------------------------------------------
...
type = ChangeState
value = 260
triggerall = command = "b" && command = "c" && command != "holddown"
trigger1 = statetype = S && ctrl
trigger2 = stateno = 3100
trigger3 = stateno = 200 && movecontact
trigger4 = stateno = 210 && movecontact
